...
conf.read(BASE_DIR + '/wechat/setting.ini')
...
qiniu_access_key = conf.get('global', 'qiniu_access_key')
qiniu_secret_key = conf.get('global', 'qiniu_secret_key')


appid = conf.get('global', 'appid')
apps = conf.get('global', 'apps')
